...
<div class="img-box">
  <img src="{{ site.baseurl }}/static/img/post/2018-11-12-10.png" alt="자바스크립트 출력확인" />
</div>
  ...
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-11.png" alt="자바스크립트 출력확인" />
  </div>
  <p>Math.max() : 입력된 수 중에서 가장 높은 값을 반환합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-12.png" alt="자바스크립트 출력확인" />
  </div>
  <p>Math.random() : 0 ~ 1 사이의 실수값을 구합니다. , * 10 을 해줄경우 0 ~ 10 사이의 실수값을 구합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-13.png" alt="자바스크립트 출력확인" />
  </div>
...
{% endhighlight %}
  ...
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-14.png" alt="자바스크립트 출력확인" />
  </div>
   <p>Math.round() : 값을 반올림 합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-15.png" alt="자바스크립트 출력확인" />
  </div>
   <p>Math.ceil() : 값을 무조건 올림 합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-16.png" alt="자바스크립트 출력확인" />
  </div>
  <p>Math.abs() : 절대값을 반환합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-17.png" alt="자바스크립트 출력확인" />
  </div>
  <p>Math.pow() : 제곱값을 반환합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-18.png" alt="자바스크립트 출력확인" />
  </div>
  <p>Math.sqrt() : 제곱근,루트값을 반환합니다.</p>
  <div class="img-box">
    <img src="{{ site.baseurl }}/static/img/post/2018-11-12-19.png" alt="자바스크립트 출력확인" />
  </div>
